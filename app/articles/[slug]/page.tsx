...
// 追加のスタイル処理は不要）。
function renderArticleImage(imgNode: Element, maxWidthPx: number | null) {
    ...
    const containerClasses = `my-2 flex flex-col items-center ${bleedOnMobile ? '-mx-3 lg:mx-0' : ''} ${maxWidthPx !== null ? '' : customWidthClass}`;
        ...
        if (domNode instanceof Element && domNode.type === 'tag') {
            ...
            if (domNode.name === 'figure') {
                ...
                if (imgNode) {
                    ...
                    return (
                        <figure>
                            {renderArticleImage(imgNode, maxWidthPx)}
                            {figcaptionNode && (
                                <figcaption>
                                    {cleanedCaption}
            ...
            if (domNode.name === 'img') {
                return renderArticleImage(domNode, null);
            }
        }
    }
};
