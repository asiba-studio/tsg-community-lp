...
import { StatementShort } from "@/components/archive/3rd/Statement";
...
export default async function Page() {
  ...
  const openTalks = OPEN_TALKS.slice(2, 4); // 3期で開催した2件を表示
            ...
            <section className="w-full section-spacing border-t border-border">
              ...
              <div className="w-full">
                <div className="hidden lg:block w-full">
                  <ContentList contents={articles} basePath="/articles" columns={1} gap={100} enableMosaic={true} programTerms={['3RD']} />
                </div>
                <div className="block lg:hidden w-full">
                  <ContentList contents={articles} basePath="/articles" columns={1} gap={100} enableMosaic={false} programTerms={['3RD']} />
                </div>
              </div>
