  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="lg:hidden backdrop-blur-md backdrop-saturate-300 bg-white/25 
        ...
        relative z-10"
      >
        <Link href="/news/press-release" className='no-underline' onClick={onClose}>About</Link>
        <Link href="/articles" className='no-underline' onClick={onClose}>Articles</Link>
        <Link href="/articles#news" className='no-underline' onClick={onClose}>News</Link>
        <Link href="/news/press-release#application" className='no-underline' onClick={onClose}>Application</Link>
      </div>
    </div>
  );
}
