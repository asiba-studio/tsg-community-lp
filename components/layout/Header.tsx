    ...
    return (
        <div className="sticky top-0 z-50 w-full">
            <header className="w-full">
                <nav className="flex justify-between items-start md:items-center py-1.5 md:py-2">
                    <div>
                    ...
                    <div className="flex flex-col items-end gap-1 md:gap-2 md:flex-row md:items-center lg:gap-6 font-en font-medium text-base lg:text-lg px-2 lg:px-6">
