...
export default function ProgramDetailSection() {
    return (
        <div>
            <h2 className="leading-none inline-block text-primary font-en">
                Program
            </h2>
            ...
            <ProgramPoint title="コミュニティづくりを実践しているプレイヤーからのレクチャーの開催" className="pt-20">
            ...
            <ProgramPoint title="イベントを体感し、自分の世界観に反映する">
            ...
            <ProgramPoint title="約3ヶ月間フルで場づくりに挑戦する、場づくりの実験室">
            ...
            <ProgramPoint title="場をつくる人たちのコミュニティ">
